        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>TISSER</h3>
                </a>
...
<body class="bdy">
  ...
  <div class="container">
    <div class="form1">
      <form class="frm" action="join_connection.php" method="post" >
              <div class="row">
                      <div  class="cls col-12 col-md-5">
                           <img src="upload/<?php echo $row3['photo'];?>" style="height: 300px;width: 300px;">
                      </div>
                      <div class="cls col-12 col-md-7">
                                <div class="cls1">
                                       <label>Name</label>
                                </div>
                                <div class="in1">
              ...
              <div  class="cls mm col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <input class="btn btn-sm btn-primary fff" type="submit" value="Submit"  name="sub"  >
                        </div>
                        <div class="in col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                          
                        <a class="btn btn-sm btn-primary ffff" href="close.php?ids=<?php echo $row3['id'];?>">CLOSE</a>
                        </div>
              </div>


                <input type="hidden" name="fn" value="<?php echo $row3['name'];?>">
                <input type="hidden" name="pend" value="1">
