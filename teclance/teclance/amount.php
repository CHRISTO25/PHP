...
<body>
	...
	<div class=" ha">
		<div class="form1">
			<form class="clsi" action="amount_connection.php" method="post" enctype="multipart/form-data">
				<div class="row">
				...
				<div class="row">
                    ...
                    <select id="mySelect" name="fname" class='custom-select'>
