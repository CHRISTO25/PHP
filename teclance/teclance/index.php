        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>TECHLANCE</a>
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>FEES</a> 
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <!-- <a href="gra.php" class="dropdown-item">chart</a> -->
                    </div>
                  ...
                  <a href="courses.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>ADD COURSE</a>
                   ...
                   <a href="reg_form.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>ADD TRAINEE</a>
                     <?php
                            ...
                            ?>
                    <a href="chart.php" class="nav-item nav-link "><i class="fa fa-chart-bar me-2"></i>FOLLOW UP</a>
                     <?php
                        }
                    ?>  
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php
                                   $sql6 = "SELECT * FROM reg_form WHERE `pen`=0";
                                   $result2 = mysqli_query($conn, $sql6);
                                   $aa= mysqli_num_rows($result2);
                                  
                                   ?>
                                   
                                <h6 class="mb-0"> <?php echo $aa;?> </h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2"><a class="btn p-0 " href="total_number.php">Total Number</a></p>
                                <?php
                              //   require 'reg_database.php';
                                ...
                                ?>
                                <h6 class="ee mb-0"><?php echo $aa; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">CLOSED MEMBERS</p>
                                <?php
                                $sql44 = "SELECT * FROM reg_form WHERE `pen`= 2";
                                   $result44 = mysqli_query($conn, $sql44);
                                   $aaa = mysqli_num_rows($result44);
                                mysqli_close($conn);
                                   ?>
                                   
                                <h6 class="mb-0"><?php echo $aaa;?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">about Reven</p>
                                <h6 class="mb-0">Pictorial</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://www.tissertech.com/">TISSER</a>
                        </br>
                        Distributed By <a class="border-bottom" href="https://tissertechnologies.com/" target="_blank">Tisser Technology</a>
                        </div>
                    </div>
                </div>
            </div>
