...
$sql3= "SELECT * FROM `courses` WHERE status = 1 ORDER BY course_name ASC";
...
<body>
	...
	<div class=" ha">
		<div class="form1">
			<form class="clsi" action="feepayment_connection.php" method="post" enctype="multipart/form-data">
				<div class="row">
				...
				<h2 align="center"><u>ADD COURSE'S</u></h2><br><br>
                ...
                <div class="row">
                        ...
                        <div class="in col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                    ...
                                    $(document).ready(function(){
                                            ...
                                            if(courseID){
                                                $.ajax({
                                                    ...
                                                    success:function(html){
                                                        ...
                                                        $('#student').html('<option value="">Select amount first</option>'); 
                                                    }
                                                }); 
                                            }else{
                                                $('#amount').html('<option value=""> course </option>');
                                                $('#student').html('<option value=""> amount </option>'); 
                                            }
                                        });
                                        ...
                                        $('#amount').on('change', function(){
                                            ...
                                            if(amountID){
                                                ...
                                                $('#student').html('<option value="">Select ampount first</option>'); 
                                            }
                                        });
                                    });
                                    </script>
              ...
              <div class="row">
                        <div  class="cls mm col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                         <label>PAYMENT meathod</label> 
                        </div>
                        <div class="in col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                       
<input type="radio" name="tab" value="1" id = "zxzx" onclick="show1();" />
LUMSUM
...
<div id="div1" class="hide">
               <div class="row">
					<div class="cls col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
						<label>COUNT</label>	
					</div>
					<div class="cls col-12 col-sm-6 col-md-6 col-lg-6 col-xl-8 col-xxl-6">
						<input type="number" name="numbe" id="nu" onchange="show3();"
                ...
                <!-- <input type =submit value = ok> -->
                                ...
                                </div>              <!-- <button type="button" class="btn btn-outline-primary m-2"  onclick="show3();"  >OK</button>  -->
                    ...
                    function show3(){
                        ...
                        document.cookie = "myJavascriptVare = " + y ;
...
$(document).ready(function(){
	...
	$.post( "fkp.php", { cs:cs,amount:amount,student:student })
  .done(function( respo ) {
    // alert(respo);
	$('#div2').html(respo);
  });
