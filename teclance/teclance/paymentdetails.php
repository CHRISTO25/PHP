...
$uuid=$_SESSION["USERID"];
$sql4= "SELECT * FROM `reg_form` WHERE `id`='$ids'";
...
?>
  ...
  <div class="container">
    <div class="form1">
      <form class="frm" action="trick.php" method="post">
              <!-- <div class="row">
...
$sql99= "SELECT * FROM `payed` WHERE `p_student`='$ids'";
              ...
              while($bat>=1) 
{
  ?>
   <tr>
                                ...
                                <td> payment</td>
                                <td> <?php echo $amt ;?></td>
                              <td>  <a class="btn btn-sm btn-primary" href="receipt.php?ids=<?php echo $row3['id'];?>&& am=<?php echo $amt ;?>">pay</a></td>
                                <?php $bat=$bat-1;?>
                            </div>
...
?>  
   ...
   {
       echo '<h2 style = color:red;>PAYMENT CLOSED</h2>'; 
   } 
                     ?>      
